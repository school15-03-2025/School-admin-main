...
const Videos = () => {
  ...
  return (
    <>
      ...
      <div className="flex gap-3 mt-3 items-end justify-between">
        <div>
          <button
            type="button"
            className="inline-flex items-center py-3 px-3 text-sm font-medium text-white bg-gray-700 rounded-lg border border-gray-700 "
          >
            Create Video
          </button>
        </div>
